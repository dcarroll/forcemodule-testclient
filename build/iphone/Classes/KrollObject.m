...
//@interface moduletest2Object : NSObject
//@end

@interface moduletest2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[moduletest2Object class]])
		{
			for (NSString *key in [[(moduletest2Object*)o modules] allKeys])
			{
