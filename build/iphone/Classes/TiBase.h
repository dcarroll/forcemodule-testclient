...
// in simulator we redefine to format for moduletest2 Developer console
...
{\
	NSString * exceptionName = [@"org.moduletest2." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.moduletest2";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UImoduletest2NativeItemNone = -1, 
	UImoduletest2NativeItemSpinner = -2,
	UImoduletest2NativeItemProgressBar = -3,
	
	UImoduletest2NativeItemSlider = -4,
	UImoduletest2NativeItemSwitch = -5,
	UImoduletest2NativeItemMultiButton = -6,
	UImoduletest2NativeItemSegmented = -7,
	
	UImoduletest2NativeItemTextView = -8,
	UImoduletest2NativeItemTextField = -9,
	UImoduletest2NativeItemSearchBar = -10,
	
	UImoduletest2NativeItemPicker = -11,
	UImoduletest2NativeItemDatePicker = -12,
	
	UImoduletest2NativeItemInfoLight = -13,
	UImoduletest2NativeItemInfoDark = -14,
	
	UImoduletest2NativeItemDisclosure = -15,
	
	UImoduletest2NativeItemContactAdd = -16
};
